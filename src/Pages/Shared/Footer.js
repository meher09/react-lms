...
const Footer = () => {
    return (
        <footer aria-label="Site Footer" className="bg-black text-grey">
            <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                    <div className="mx-auto max-w-sm lg:max-w-none">
                        ...
                        <div className="mt-6 flex justify-center gap-4 lg:justify-start">
                            <a className="text-white transition hover:text-gray-600"
                                href="/</div>"
                                target="_blank"
                                rel="noreferrer"
                            >
                            ...
                            <a
                                className="text-white transition hover:text-zinc-100/75"
                                href="/"
                                target="_blank"
                                rel="noreferrer"
                            >
                    ...
                    >
                        <div>
                            ...
                            >
                                <a className="text-white transition hover:text-zinc-100/75" href="/">
                                    Marketing
                                </a>
                                <a className="text-white transition hover:text-zinc-100/75" href="/">
                                    Graphic Design
                ...
                <div className="mt-16 border-t border-gray-100 pt-8">
                    <p className="text-center text-xs leading-relaxed text-gray-500">
                        ...
                        <a
                            href="/"
                            className="text-white ml-5 underline transition hover:text-zinc-100/75"
                        >আইটি শিক্ষা টিম</a>
